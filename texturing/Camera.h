...
{
public:
    Camera(glm::vec3 position = glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3 newUp = glm::vec3(0.0f, 1.0f, 0.0f),
           float newYaw = -89.0f, float newPitch = 56.0f, float radius = 0.05f)
    {
        pos = position;
        worldUp = newUp;
        yaw = newYaw;
        ...
        posMiniMap = glm::vec3(-0.356977, 2.93215, 3.02613);

        ViewMiniMap = glm::lookAt(
                posMiniMap, // Camera is at (4,3,-3), in World Space
                glm::vec3(-0.00622547, 2.27127, 2.36264

                ), // Camera is at (4,3,-3), in World Space
                // and looks at the origin
                glm::vec3(0.308872, 0.75049, -0.584263
    ...
    glm::vec3 getPosMiniMap() const;
    glm::vec3 getPosThirdPerson() const;
